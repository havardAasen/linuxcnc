...
#ifdef MODULE_INFO
MODULE_INFO(linuxcnc, "component:constant:Use a parameter to set the value of a pin");
MODULE_INFO(linuxcnc, "pin:out:float:0:out::None:None");
MODULE_INFO(linuxcnc, "param:value:float:0:rw::None:None");
...
static int export(char *prefix, long extra_arg) {
    ...
    r = hal_pin_float_newf(HAL_OUT, &(inst->out_p), comp_id,
        "%s.out", prefix);
    if(r != 0) return r;
    r = hal_param_float_newf(HAL_RW, &(inst->value_p), comp_id,
        "%s.value", prefix);
    if(r != 0) return r;
...
#line 8 "/home/end/projects/linuxcnc/src/hal/components/constant.comp"
FUNCTION(_) {
    out = value;
}
