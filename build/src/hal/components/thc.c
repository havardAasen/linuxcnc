...
#ifdef MODULE_INFO
MODULE_INFO(linuxcnc, "component:thc:Torch Height Control");
...
MODULE_INFO(linuxcnc, "param:vel_scale:float:0:rw:The scale to convert the Velocity signal to Volts:None:None");
MODULE_INFO(linuxcnc, "param:scale_offset:float:0:rw:The offset of the velocity input at 0 volts:None:None");
MODULE_INFO(linuxcnc, "param:velocity_tol:float:0:rw:The deviation percent from planned velocity:None:None");
MODULE_INFO(linuxcnc, "param:voltage_tol:float:0:rw:The deviation of Tip Voltage before correction takes place:None:None");
MODULE_INFO(linuxcnc, "param:correction_vel:float:0:rw:The amount of change in user units per period to move Z to correct:None:None");
...
struct __comp_state {
    ...
    hal_float_t *encoder_vel_p;
    hal_float_t *current_vel_p;
    hal_float_t *requested_vel_p;
    hal_float_t *volts_requested_p;
    hal_float_t *vel_tol_p;
    ...
    hal_float_t *offset_value_p;
    hal_float_t vel_scale_p;
    hal_float_t scale_offset_p;
    hal_float_t velocity_tol_p;
    hal_float_t voltage_tol_p;
...
static int export(char *prefix, long extra_arg) {
    ...
    memset(inst, 0, sz);
    r = hal_pin_float_newf(HAL_IN, &(inst->encoder_vel_p), comp_id,
    ...
    if(r != 0) return r;
    r = hal_pin_float_newf(HAL_IN, &(inst->volts_requested_p), comp_id,
        "%s.volts-requested", prefix);
    if(r != 0) return r;
    r = hal_pin_float_newf(HAL_IN, &(inst->vel_tol_p), comp_id,
        "%s.vel-tol", prefix);
    if(r != 0) return r;
    ...
    r = hal_pin_float_newf(HAL_OUT, &(inst->z_fb_out_p), comp_id,
        "%s.z-fb-out", prefix);
    if(r != 0) return r;
    r = hal_pin_float_newf(HAL_OUT, &(inst->volts_p), comp_id,
        "%s.volts", prefix);
    if(r != 0) return r;
    r = hal_pin_bit_newf(HAL_OUT, &(inst->vel_status_p), comp_id,
        "%s.vel-status", prefix);
    if(r != 0) return r;
    r = hal_pin_float_newf(HAL_OUT, &(inst->offset_value_p), comp_id,
        "%s.offset-value", prefix);
    if(r != 0) return r;
    r = hal_param_float_newf(HAL_RW, &(inst->vel_scale_p), comp_id,
        "%s.vel-scale", prefix);
    if(r != 0) return r;
    r = hal_param_float_newf(HAL_RW, &(inst->scale_offset_p), comp_id,
        "%s.scale-offset", prefix);
    if(r != 0) return r;
    r = hal_param_float_newf(HAL_RW, &(inst->velocity_tol_p), comp_id,
        "%s.velocity-tol", prefix);
    if(r != 0) return r;
    r = hal_param_float_newf(HAL_RW, &(inst->voltage_tol_p), comp_id,
...
#undef encoder_vel
#undef encoder_vel_ptr
#define encoder_vel_ptr (__comp_inst->encoder_vel_p)
#define encoder_vel (0+*__comp_inst->encoder_vel_p)
#undef current_vel
...
#undef volts_requested_ptr
#define volts_requested_ptr (__comp_inst->volts_requested_p)
#define volts_requested (0+*__comp_inst->volts_requested_p)
#undef vel_tol
#undef vel_tol_ptr
#define vel_tol_ptr (__comp_inst->vel_tol_p)
#define vel_tol (0+*__comp_inst->vel_tol_p)
#undef torch_on
#undef torch_on_ptr
...
#undef volts
#undef volts_ptr
#define volts_ptr (__comp_inst->volts_p)
#define volts (*__comp_inst->volts_p)
#undef vel_status
#undef vel_status_ptr
#define vel_status_ptr (__comp_inst->vel_status_p)
#define vel_status (*__comp_inst->vel_status_p)
#undef offset_value
#undef offset_value_ptr
#define offset_value_ptr (__comp_inst->offset_value_p)
#define offset_value (*__comp_inst->offset_value_p)
#undef vel_scale
#define vel_scale (__comp_inst->vel_scale_p)
#undef scale_offset
#define scale_offset (__comp_inst->scale_offset_p)
#undef velocity_tol
#define velocity_tol (__comp_inst->velocity_tol_p)
#undef voltage_tol
#define voltage_tol (__comp_inst->voltage_tol_p)
...
#line 91 "/home/end/projects/linuxcnc/src/hal/components/thc.comp"
