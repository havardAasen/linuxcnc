...
// Get the parameter file name from the INI file.
 ...
 constexpr void set_tool_parameters() noexcept;
...
/* Internal arrays */
 ...
 private:
    constexpr void init_tool_parameters() noexcept;
    constexpr void default_tool_parameters() noexcept;
};

constexpr void Interp::init_tool_parameters() noexcept
{
...
constexpr void Interp::default_tool_parameters() noexcept
{
...
constexpr void Interp::set_tool_parameters() noexcept
{
